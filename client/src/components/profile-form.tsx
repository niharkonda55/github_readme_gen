              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex-1">
                    ...
                    <FormControl>
                      <Input placeholder="AryanShivva" {...field} value={field.value || ""} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Aryan Shivva" {...field} value={field.value || ""} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="email" placeholder="aryanshivva20@gmail.com" {...field} value={field.value || ""} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Working on Android Development, Learning Kotlin..." {...field} value={field.value || ""} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                onClick={() => appendSection({ title: "", content: "", order: sectionFields.length })}
              >
                <Plus className="h-4 w-4 mr-2" />
                Add Section
              </Button>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="My Projects, Achievements, etc." {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
